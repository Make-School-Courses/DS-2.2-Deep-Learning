You will be completing the binary classification project of identifying if an image has fire in it or not using Convolutional Neural Networks and Multi Layer Perceptrons.
